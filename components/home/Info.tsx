    ...
    <div className="w-full lg:pl-32">
      <div className="w-full rounded-lg p-5 border dark:border-neutral-700 border-neutral-200 mb-10">
        <div className="flex items-center mb-4">
          <FontAwesomeIcon
            className="text-xl text-neutral-400  mr-4 "
            icon={faEnvelope}
            mask={["far", "circle"]}
          />
          <span className="dark:text-neutral-100 text-neutral-600">
            Stay up to date
          </span>
        </div>
        <p className="mb-6 text-sm dark:text-neutral-400 text-neutral-500 ">
